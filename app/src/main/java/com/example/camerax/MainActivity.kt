...
/*
Following use cases covered for camerax api
    1.) Preview use case
    2.) ImageCapture use case
    3.) ImageAnalysis use case
...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private val REQUIRED_PERMISSIONS =
            mutableListOf (android.Manifest.permission.CAMERA, android.Manifest.permission.RECORD_AUDIO).apply {
    ...
    private val activityResultLauncher = registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            ...
            if (!permissionGranted) {
                Toast.makeText(baseContext, getString(R.string.permission_request_denied), Toast.LENGTH_SHORT).show()
            } else {
                startCamera(0)
            }
        }
    ...
    private fun startCamera(pos: Int) {
        ...
        cameraProviderFuture.addListener({
                ...
                .also {
                    it.setAnalyzer(cameraExecutor, LuminosityAnalyzer { luma ->
                        ...
                        CoroutineScope(Dispatchers.Main).launch {
                            if (luma < 3)
                                binding.tvCameraBlocked.visibility = View.VISIBLE
                            else
                                binding.tvCameraBlocked.visibility = View.GONE
                        }
                    })
                }
            ...
            try {
                ...
                if (pos == 1) {
                    ...
                    // Bind use cases to camera video
